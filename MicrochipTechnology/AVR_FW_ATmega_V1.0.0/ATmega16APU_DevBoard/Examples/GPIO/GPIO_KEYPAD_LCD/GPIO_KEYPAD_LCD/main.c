...
unsigned char Keypad(void)
{
	...
	_delay_ms(1);
	if(!(KEY_PIN & (1 << C1))) { _delay_ms(20); while(!(KEY_PIN & (1 << C1))); _delay_ms(20); number = 0x01; }  // 1
	if(!(KEY_PIN & (1 << C2))) { _delay_ms(20); while(!(KEY_PIN & (1 << C2))); _delay_ms(20); number = 0x02; }  // 2
	if(!(KEY_PIN & (1 << C3))) { _delay_ms(20); while(!(KEY_PIN & (1 << C3))); _delay_ms(20); number = 0x03; }  // 3
	if(!(KEY_PIN & (1 << C4))) { _delay_ms(20); while(!(KEY_PIN & (1 << C4))); _delay_ms(20); number = 0x0A; }  // F1
	...
	_delay_ms(1);
	if(!(KEY_PIN & (1 << C1))) { _delay_ms(20); while(!(KEY_PIN & (1 << C1))); _delay_ms(20); number = 0x04; }  // 4
	if(!(KEY_PIN & (1 << C2))) { _delay_ms(20); while(!(KEY_PIN & (1 << C2))); _delay_ms(20); number = 0x05; }  // 5
	if(!(KEY_PIN & (1 << C3))) { _delay_ms(20); while(!(KEY_PIN & (1 << C3))); _delay_ms(20); number = 0x06; }  // 6
	if(!(KEY_PIN & (1 << C4))) { _delay_ms(20); while(!(KEY_PIN & (1 << C4))); _delay_ms(20); number = 0x0B; }  // F2
	...
	KEY_PORT |= (1 << R4);  // R4 = 1
	_delay_ms(1);
	if(!(KEY_PIN & (1 << C1))) { _delay_ms(20); while(!(KEY_PIN & (1 << C1))); _delay_ms(20); number = 0x07; }  // 7
	if(!(KEY_PIN & (1 << C2))) { _delay_ms(20); while(!(KEY_PIN & (1 << C2))); _delay_ms(20); number = 0x08; }  // 8
	if(!(KEY_PIN & (1 << C3))) { _delay_ms(20); while(!(KEY_PIN & (1 << C3))); _delay_ms(20); number = 0x09; }  // 9
	if(!(KEY_PIN & (1 << C4))) { _delay_ms(20); while(!(KEY_PIN & (1 << C4))); _delay_ms(20); number = 0x0C; }  // F3

	// Row 4 (R4 low, others high)
	KEY_PORT |= (1 << R1) | (1 << R2) | (1 << R3);  // R1, R2, R3 = 1
	KEY_PORT &= ~(1 << R4);  // R4 = 0
	_delay_ms(1);
	if(!(KEY_PIN & (1 << C1))) { _delay_ms(20); while(!(KEY_PIN & (1 << C1))); _delay_ms(20); number = 0x0E; }  // *
	if(!(KEY_PIN & (1 << C2))) { _delay_ms(20); while(!(KEY_PIN & (1 << C2))); _delay_ms(20); number = 0x00; }  // 0
	if(!(KEY_PIN & (1 << C3))) { _delay_ms(20); while(!(KEY_PIN & (1 << C3))); _delay_ms(20); number = 0x0F; }  // #
	if(!(KEY_PIN & (1 << C4))) { _delay_ms(20); while(!(KEY_PIN & (1 << C4))); _delay_ms(20); number = 0x0D; }  // F4
